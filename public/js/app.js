...
var CardUI = React.createClass({
    ...
    getSelectedCards: function getSelectedCards() {
        ...
        var selectedCards = [];
        this.props.cards.map(function (card, i) {
            if (_this.state.cardStatus[i] == 'selected') {
    ...
    render: function render() {
        ...
        if (currUserFlag) {
            displayText = React.createElement(
                ...
                null,
                this.props.cards.map(function (card, i) {
                    var btnStatus = _this2.state.cardStatus[i];
                    var buttonValue = "";
                    ...
                    var cardImgName = String(number) + "_of_" + String(_this2.state.traitList[trait]) + ".png";
                    // console.log(cardImgName);
                    // console.log("0-------------------");
                    var imgPath = "images/PNG-cards-1.3/" + String(cardImgName);
                    if (btnStatus == 'selected') {
                        buttonValue = React.createElement(
                            'button',
                            { id: i, className: 'displaySelectedCard', onClick: _this2.handleClick },
                            React.createElement('img', { id: i, src: imgPath, className: 'displaySelectedImage' })
                        );
                    } else {
                        buttonValue = React.createElement(
                            'button',
                            { id: i, className: 'displayDefaultCard', onClick: _this2.handleClick },
                            React.createElement('img', { id: i, src: imgPath, className: 'displayDefaultImage' })
                        );
                    }
                    return { buttonValue: buttonValue };
                })
            );
            if (this.props.userChanceBool == true) {
                var passBtnUI = React.createElement(
                    'button',
                    { id: 'pass', onClick: this.handleOptionClick, className: 'btnPass' },
                    'pass'
                );
                var submitBtnUI = React.createElement(
                    'button',
                    { id: 'submit', onClick: this.handleOptionClick, className: 'btnSubmit' },
                    'submit'
                );
                var checkBtnUI = React.createElement(
                    'button',
                    { id: 'check', onClick: this.handleOptionClick, className: 'btnCheck' },
                    'check'
                );
                if (this.props.checkNewTurn()) {
                    checkBtnUI = React.createElement(
                        'button',
                        { id: 'check', className: 'disabledBtnCheck' },
                        'check'
                    );
                }
                var playedCard = this.getSelectedCards();
                if (playedCard.length == 0) {
                    submitBtnUI = React.createElement(
                        'button',
                        { id: 'submit', onClick: this.handleOptionClick, className: 'disabledBtnSubmit' },
                        'submit'
                    );
                }
                playerOptions = React.createElement(
                    'div',
                    { className: 'optionButtonUI' },
                    passBtnUI,
                    submitBtnUI,
                    checkBtnUI
                );
            ...
            displayText = React.createElement(
                'div',
                null,
                React.createElement('img', { src: 'images/abc.png', className: cardClass }),
                React.createElement(
                    'div',
                    { className: cardCntClass },
...
var PlayerUI = React.createClass({
    ...
    getPosition: function getPosition(user, currPlayerIndex) {
    ...
    render: function render() {
        ...
        return React.createElement(
            ...
            null,
            this.props.users.map(function (user, i) {
                var position = _this3.getPosition(currUser, i);
                var currPlayerClass = playerClass + String(position);
                var userChance = _this3.props.userChance;
                ...
                if (i == userChance) {
                    ...
                    if (user != currUser && !playerMoveInfo) {
                        ...
                        playerMoveInfo = React.createElement(
                            'div',
                            { className: 'moveplaying' },
                            'playing...'
                        );
                    }
                } else {
                ...
                if (user != currUser) {
                    var userName = React.createElement(
                        'h3',
                        { style: { color: "navajowhite" } },
                        user
                    );
                }
                var CardUIDiv = React.createElement(CardUI, {
                    user: user,
                    currUser: currUser,
                    cards: _this3.props.cards,
                    baseCard: _this3.props.baseCard,
                    userChanceBool: userChanceBool,
                    position: position,
                    checkNewTurn: _this3.props.checkNewTurn,
                    handleSubmitButton: _this3.props.handleSubmitButton,
                    handleCheckButton: _this3.props.handleCheckButton,
                    handlePassButton: _this3.props.handlePassButton
                });
                return React.createElement(
                    'div',
                    { className: currPlayerClass },
                    playerMoveInfo,
                    userName,
                    CardUIDiv
                );
...
var TableUI = React.createClass({
    ...
    renderListItems: function renderListItems() {
        ...
        for (var i = 0; i < this.state.rankList.length; i++) {
            ...
            items.push(React.createElement(
                'div',
                { onClick: this.select.bind(null, item), className: 'rankItem' },
                item.name
            ));
        }
        return items;
    ...
    getBaseCardName: function getBaseCardName(baseCard) {
        if (!baseCard) {
            return 'Choose card';
        }
    ...
    render: function render() {
        ...
        if (newTurn == 0) {
            ...
            var baseCardSelector = React.createElement(
                'div',
                null,
                React.createElement(
                    'span',
                    { className: 'dropdown-display-disabled' },
                    this.getBaseCardName(this.props.baseCard)
                )
            );
            var tableCardsUI = React.createElement(
                'div',
                null,
                React.createElement('img', { src: 'images/abc.png', className: 'displayTableCard' }),
                ';',
                React.createElement(
                    'div',
                    { className: 'displayTableCnt' },
                    cnt
                ),
                ';'
            );
        ...
        if (this.props.displayCards) {
            ...
            var displayCardUI = React.createElement(
                'div',
                { className: 'displayModal' },
                React.createElement(
                    'div',
                    { className: 'displayCardUI' },
                    ' ',
                    this.props.displayCards.map(function (card, i) {
                        var buttonValue = "";
                        var trait = parseInt(card / 100);
                        var number = parseInt(card % 100);
                        if (number == 1) {
                        ...
                        var cardImgName = String(number) + "_of_" + String(_this4.state.traitList[trait]) + ".png";
                        // console.log(cardImgName);
                        var imgPath = "images/PNG-cards-1.3/" + String(cardImgName);
                        // console.log(imgPath);
                        buttonValue = React.createElement(
                            'button',
                            { id: i, className: 'displayDefaultCard' },
                            React.createElement('img', { id: i, src: imgPath, className: 'displayDefaultImage' })
                        );
                        return { buttonValue: buttonValue };
                    })
...
var Message = React.createClass({
    ...
    render: function render() {
        ...
        return React.createElement(
            'div',
            { className: 'message', style: msgStyle },
            React.createElement(
                'div',
                { className: 'colorMessage', style: colorMsgStyle },
                userName,
                React.createElement(
                    'span',
                    null,
...
var MessageTab = React.createClass({
    ...
    render: function render() {
        ...
        return React.createElement('div', { className: tabClass, onClick: this.handleClick });
    }
});
...
var MessageBar = React.createClass({
    ...
    scrollElement: function scrollElement(messageBar) {
    ...
    setMessageBar: function setMessageBar(flag) {
        console.log(flag);
    ...
    render: function render() {
        ...
        if (this.state.showMessageBar) {
            ...
            var messageBar = React.createElement(
                'div',
                { className: 'messageBarUI'
                },
                React.createElement(MessageList, { ref: function (messageBar) {
                        _this5.domMessageBar = messageBar;
                    },
        ...
        return React.createElement(
            'div',
            null,
            React.createElement(MessageTab, {
...
var IntroPageUI = React.createClass({
    ...
    setRespRoom: function setRespRoom(respRoom) {
        console.log(respRoom);
        var error = respRoom.error;
        var room = respRoom.room;
        var name = respRoom.name;
    ...
    render: function render() {
        if (this.state.inputNameFlag) {
            ...
            var inputNameUI = React.createElement(
                'div',
                null,
                React.createElement('input', {
                    onChange: this.changeHandler,
        ...
        if (this.state.inputRoomFlag) {
            var inputRoomUI = React.createElement(
                'div',
                null,
                React.createElement(
                    'button',
...
var GameUI = React.createClass({
    ...
    _gameStart: function _gameStart(data) {
        ...
        // console.log(data);
        // console.log("--");
        var userChance = data.userChance;

        this.setState({ userChance: userChance });
    },

    _submitButton: function _submitButton(data) {
        var name = data.name;
        var cards = data.cards;
    ...
    _chanceChange: function _chanceChange(data) {
        var userChance = data.userChance;

        this.setState({ userChance: userChance });
    },

    _updateCards: function _updateCards(data) {
        var cards = data.cards;
    ...
    _updateTable: function _updateTable(data) {
        console.log("in _updateTable");
        // console.log(data);
        var tableCardsCnt = data.tableCardsCnt;
        var newTurn = data.newTurn;
        var displayAnimation = data.displayAnimation;

        console.log(displayAnimation);
        if (displayAnimation) {
            var player = displayAnimation.player;
            var cardCnt = displayAnimation.cardCnt;
            var move = displayAnimation.move;
            ...
            if (move == "add") {
                ...
                var animationUI = React.createElement(
                    'div',
                    { className: playerClass },
                    React.createElement('img', { src: imgPath, className: 'displayDefaultImage' })
                );
    ...
    _lastSubmit: function _lastSubmit(data) {
    ...
    _setBaseCard: function _setBaseCard(data) {
        var baseCard = data.baseCard;

        this.setState({ baseCard: baseCard });
    },

    _displayMove: function _displayMove(data) {
        ...
        tmpMoveInfoHistory.push({});
        // console.log(data);
        var moveInfoList = data.moveInfoList;
        var topCards = data.topCards;
        ...
        for (var i = 0; i < moveInfoList.length; i++) {
            ...
            var player = moveInfo.player;
            var cnt = moveInfo.cnt;
            var baseCard = moveInfo.baseCard;
            var moveType = moveInfo.moveType;
    ...
    _gameOver: function _gameOver(data) {
        console.log(data);
        alert(data['winner']);
    },

    _createRoom: function _createRoom(data) {
        console.log(data);
        this.introPageRef.setRespRoom(data);
    },

    _joinRoom: function _joinRoom(data) {
        console.log(data);
        this.introPageRef.setRespRoom(data);
    },

    _submitName: function _submitName(data) {
        console.log(data);
    },
    ...
    clearCards: function clearCards(data) {
        this.setState({ displayCards: null });
    },

    handleSubmitButton: function handleSubmitButton(data) {
        var tmpData = {};
        // console.log("-----");
    ...
    handlePassButton: function handlePassButton(data) {
        socket.emit('pass:button', data);
    },

    handleCheckButton: function handleCheckButton(data) {
        var player = data.player;
    ...
    setNewBaseCard: function setNewBaseCard(data) {
    ...
    setModalUI: function setModalUI(data) {
        console.log(data);
        if (data == "show") {
            var rankListUI = React.createElement(
                'div',
                { className: 'myModal' },
                React.createElement(
                    'div',
    ...
    checkNewTurn: function checkNewTurn() {
        return this.state.newTurn;
    },

    handleCreateRoom: function handleCreateRoom() {
        var data = { socketId: socket.id };
        socket.emit('create:room', data);
    },

    handleJoinRoom: function handleJoinRoom(room) {
        var data = { socketId: socket.id, room: room };
        socket.emit('join:room', data);
    },

    handleSubmitName: function handleSubmitName(newName, oldName) {
    ...
    render: function render() {
        ...
        if (this.state.gamePageFlag) {
            var gamePageUI = React.createElement(
                'div',
                null,
                React.createElement(MessageBar, {
                    user: this.state.user
                }),
                React.createElement(TableUI, { ref: function (instance) {
                        _this6.child = instance;
                    },
            ...
            var introPageUI = React.createElement(
                'div',
                null,
                React.createElement(IntroPageUI, {
                    ref: function (instance) {
                        _this6.introPageRef = instance;
                    },
...
React.render(React.createElement(GameUI, null), document.getElementById('app'));
